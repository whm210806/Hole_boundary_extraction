...
void extractCircleOnPlaneWithNormal() {
    ...
    reader.read("/home/mike/sick_Ws/cluster_1.pcd", *cloud);
    // Step 1: 平面分割
    ...
    circle_seg.setRadiusLimits(0.05, 0.13);  // 设置圆半径的限制
    ...
    pcl::io::savePCDFileASCII("transformed_circle_boundary.pcd", *circle_points);
